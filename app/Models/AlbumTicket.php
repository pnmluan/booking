...
class AlbumTicket extends BaseModel
{
    protected $table = 'album_ticket';
    protected $fillable = ['name', 'entrance_ticket_id', 'img'];
	...
	public static function listItems(array $param = null){
		...
		$aColumns = ['name', 'entrance_ticket_id', 'img'];
		
		$query = \DB::table('album_ticket')
					->select(\DB::raw('SQL_CALC_FOUND_ROWS id'),\DB::raw('id AS DT_RowId'),'album_ticket.*');
