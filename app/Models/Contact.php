...
class Contact extends BaseModel
{
    ...
    protected $fillable = ['booking_id', 'ticket_bill_id', 'title', 'first_name', 'last_name', 'fullname', 'phone', 'email', 'requirement'];
    ...
    public static function listItems(array $param = null){
        ...
        $aColumns = ['booking_id', 'ticket_bill_id', 'title', 'first_name', 'last_name', 'fullname', 'phone', 'email', 'requirement'];
